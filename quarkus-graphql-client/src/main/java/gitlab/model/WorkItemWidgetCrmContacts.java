...
public class WorkItemWidgetCrmContacts implements WorkItemWidget {
    ...
    public WorkItemWidgetCrmContacts setType(WorkItemWidgetType type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WorkItemWidgetCrmContacts other = (WorkItemWidgetCrmContacts) obj;
        return Objects.equals(type, other.type);
    }

    @Override
    public String toString() {
        return "WorkItemWidgetCrmContacts [type=" + type + "]";
    }
